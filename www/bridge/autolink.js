 ...
 * More info: http://tudiencongnghe.net/T%E1%BB%AB_%C4%91i%E1%BB%83n_c%C3%B4ng_ngh%E1%BB%87:Autolink/Javascript
 */
Hilite = {
	...
	max_repeats: 1,
	onload: true,
	url: 'http://tudien.vntelecom.org'
};
document.write('<script language="javascript" type="text/javascript" src="' + Hilite.url + '/bridge/pages3.js"></script>');
	...
	var textproc = function(node) 
	{
		...
		if (match)
		{
			...
			if (++Hilite.repeats[page] <= Hilite.max_repeats) 
			{
				...
				link.href = Hilite.url + '/Special:Search/' + val;
...
try {
  ...
  var pageTracker = _gat._getTracker("UA-1066135-5");
  pageTracker._trackPageview("/Autolink");
} catch(err) {}
